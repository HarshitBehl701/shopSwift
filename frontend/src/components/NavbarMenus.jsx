...
function NavbarMenus({currentPage}) {
    ...
    const menuOptions = token ? defaultMenus: [...defaultMenus, ["Login", "/login"], ["Register", "/register"]];
    ...
    const profileDropdownOptions  =  {
      ...
      const currentProfileDropdownOptionsForCurrentUser =  profileDropdownOptions[currentUser];
