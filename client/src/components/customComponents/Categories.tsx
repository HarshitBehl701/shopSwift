...
function Categories() {
  ...
  return (
    <section className="py-12 bg-white text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 px-4 md:px-16">
          ...
          <div className="overflow-hidden h-44  pb-3 cursor-pointer border border-gray-300 rounded-lg shadow-md hover:shadow-lg" key={category.category_name}>
            <Avatar className="shadow-sm">
              <AvatarImage   className="object-cover object-center h-32 w-full" src={getImagePathUrl('other',category.category_image)} />
              <AvatarFallback>
